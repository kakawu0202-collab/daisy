...
FIELDS = ['po','po_line','region','sub_type','priority','cto_p1','mcid','ship_mode','scac',
    'master_type','cust','po_qty','remain_qty','ship_qty','msbd','psd','final_msbd','po_received',
...
def handle_sync(payload):
    ...
    # Store cache items (k1_summary, daily_summary, risks, kpi, e2e_kpi, asn_check, cto_asn_missing)
    for key in ('k1_summary', 'daily_summary', 'risks', 'risk_summary', 'kpi', 'e2e_kpi', 'asn_check', 'cto_asn_missing'):
