...
def handle_sync(payload):
    ...
    # Store cache items (k1_summary, daily_summary, risks, kpi, e2e_kpi, asn_check, cto_asn_missing, st_check)
    for key in ('k1_summary', 'daily_summary', 'risks', 'risk_summary', 'kpi', 'e2e_kpi', 'asn_check', 'cto_asn_missing', 'st_check'):
