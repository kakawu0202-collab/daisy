...
from rules.st import compute as st_compute
...
cto_asn_missing = cto_asn_compute(rows)
st_check = st_compute(rows)
...
# Write to engine DB
for key, data in [('k1_summary', k1), ('daily_summary', daily), ('risks', risks), ('kpi', kpi), ('asn_check', asn_check), ('cto_asn_missing', cto_asn_missing), ('st_check', st_check)]:
