...
def push(conn, records_all, k1_summary, daily_summary, risks, kpi, e2e_kpi=None, asn_check=None, cto_asn_missing=None, st_check=None):
    ...
    payload_base = {
        ...
        'cto_asn_missing': cto_asn_missing or {},
        'st_check': st_check or {},
    }
